...
test_day="240621_torch_neulf_stanford_debug"
depth="8"
width="256"
epoch="1"
...
for dataset in "${datasets[@]}"; do
    ...
    python main_neulf.py "${stanford_path}/${dataset}" --workspace "/data/result/result${test_day}/${test_day}_${dataset}_uvxy_relu_encX" --depth $depth --width $width --LF_mode uvxy --whole_epoch $epoch --eval_interval 1 
