...
stanford1="knights"
stanford2="bunny"
test_day="240618_torch_neulf_stanford_skips_new"
depth="8"
width="256"
epoch="1000"
...
for dataset in "${datasets[@]}"; do
    ...
    python main_wire_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_uvxy_relu_encX" --depth $depth --width $width --LF_mode uvxy --neulf --whole_epoch $epoch --eval_interval 10 --loss_coeff 1000 
