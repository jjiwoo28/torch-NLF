...
stanford1="knights"
stanford2="bunny"
test_day="240615_debug_llff2neulf_2_"
depth="8"
width="256"
epoch="1"
...
for dataset in "${datasets[@]}"; do
    ...
    python -m pdb scripts/stanford2neulf.py "${stanford_path}/${dataset}" --images images --downscale 1
    python -m pdb main_wire_neulf.py "${stanford_path}/${dataset}" --workspace "${test_day}_${dataset}_uvxy_relu_encX" --depth $depth --width $width --LF_mode uvxy --neulf --whole_epoch $epoch --eval_interval 1 --loss_coeff 1000
