...
stanford1="knights"
stanford2="bunny"
test_day="240618_wire_skip_debug_sigma_omega"
depth="8"
width="256"
epoch="1"
...
for dataset in "${datasets[@]}"; do
    ...
    python main_wire_neulf_wire.py "${stanford_path}/${dataset}" --workspace "${test_day}/${test_day}_${dataset}_uvxy_wire_encX_5e-4" --depth $depth --width $width --LF_mode uvxy  --whole_epoch $epoch --eval_interval 1 --loss_coeff 1000 --lr 5e-4 --sigma 4 --omega 9
    python main_wire_neulf_wire.py "${stanford_path}/${dataset}" --workspace "${test_day}/${test_day}_${dataset}_uvxy_wire_encX_5e-5" --depth $depth --width $width --LF_mode uvxy  --whole_epoch $epoch --eval_interval 1 --loss_coeff 1000 --lr 5e-5 --sigma 4 --omega 9
