...
for dataset in "${datasets[@]}"; do
    ...
    python main_wire_neulf.py "${stanford_path}/${dataset}" --workspace "${test_day}_${dataset}_uvxy_relu_encX" --depth $depth --width $width --LF_mode uvxy --neulf --whole_epoch $epoch --eval_interval 10 --loss_coeff 1000
