...
stanford1="knights"
stanford2="bunny"
test_day="240618_wire_skip_test"
depth="8"
width="256"
epoch="1"
...
for dataset in "${datasets[@]}"; do
    ...
    python main_wire_neulf_wire.py "${stanford_path}/${dataset}" --workspace "${test_day}/${test_day}_${dataset}_uvxy_wire_encX_5e-4" --depth $depth --width $width --LF_mode uvxy  --whole_epoch $epoch --eval_interval 1 --loss_coeff 1000 --lr 5e-4 --no_skips
    python main_wire_neulf_wire.py "${stanford_path}/${dataset}" --workspace "${test_day}/${test_day}_${dataset}_uvxy_wire_encX_5e-5" --depth $depth --width $width --LF_mode uvxy  --whole_epoch $epoch --eval_interval 1 --loss_coeff 1000 --lr 5e-5  --no_skips
