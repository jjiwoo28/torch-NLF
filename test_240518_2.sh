...
for dataset in "${datasets[@]}"; do
    ...
    python main_featuresplit_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_freq_and_sh_with_wire" --depth $depth --width $width --LF_mode vec --act wire  --whole_epoch $epoch 
done
...
for dataset in "${datasets[@]}"; do
    echo "Processing $dataset"
    python scripts/stanford2neulf.py "${stanford_path}/${dataset}" --images images --downscale 1
    python main_wire_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_relu_encX_eval_interval_1" --depth $depth --width $width --LF_mode vec --neulf --whole_epoch $epoch --eval_interval 1
    python main_wire_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_wire_encX_eval_interval_1" --depth $depth --width $width --LF_mode vec --whole_epoch $epoch 
    python main_featuresplit_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_freq_with_relu_eval_interval_1" --depth $depth --width $width --LF_mode vec --act relu --freq_neulf --whole_epoch $epoch --eval_interval 1
    python main_featuresplit_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_freq_with_wire_eval_interval_1" --depth $depth --width $width --LF_mode vec --act wire --freq_neulf --whole_epoch $epoch --eval_interval 1
done
...
for dataset in "${datasets[@]}"; do
    echo "Processing $dataset"
    python scripts/stanford2neulf.py "${stanford_path}/${dataset}" --images images --downscale 1
    python main_wire_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_relu_encX_d8w128" --depth $depth --width $width --LF_mode vec --neulf --whole_epoch $epoch --eval_interval 1
    python main_wire_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_wire_encX_d8w128" --depth $depth --width $width --LF_mode vec --whole_epoch $epoch 
    python main_featuresplit_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_freq_with_relu_d8w128" --depth $depth --width $width --LF_mode vec --act relu --freq_neulf --whole_epoch $epoch --eval_interval 1
    python main_featuresplit_neulf.py "${stanford_path}/${dataset}" --workspace "/data/hmjung/result${test_day}/${test_day}_${dataset}_vec_freq_with_wire_d8w128" --depth $depth --width $width --LF_mode vec --act wire --freq_neulf --whole_epoch $epoch --eval_interval 1
done
